...
public var optionsFile:Array<Dynamic> = [ // god help me
    ...
    [ // MISC
        ...
        //if(!Flags.devThing)return;
        ["Resizable Editors", "If checked, this will allow the editors to render beyond the base 1280x720.", [], 'editorResize','Bool'],
        ["Editor SFXs", "If checked, will play sound effects when working on editors.", [], 'editorSFX','Bool'],
        ["Chart Pretty Print", "If checked, the saved files from the chart editor will be formatted to be easily viewable", [], 'prettyChart','Bool'],
        ["Character Pretty Print", "If checked, the saved files from the character editor will be formatted to be easily viewable", [], 'prettyChara','Bool'],
        ["Stage Pretty Print", "If checked, the saved files from the stage editor will be formatted to be easily viewable", [], 'prettyStage','Bool'],
        ["Intensive Blur(editor)", "If checked, will use more intensive blur that may be laggier but look better.", [], 'editorBlur','Bool'],
        ["Editor Autosaves", "If checked, this will autosave your files in the editor.", [], 'editorAutosave','Bool'],
        ["Autosaving Time", "This controls how often the editor will autosave your file (in seconds...)", [60,600], 'editorAutosaveTime','Int'],
        ["Save Warning Time", "This controls how long the editor will warn you before it autosaves (in seconds..., 0 to disable)", [0,15], 'editorSaveWarnTime','Int'],
        ["Autosaves Folder", "If checked, this will autosave your file in a separate folder with a time stamp instead of overriding your current file. (song/autosaves/)", [], 'editorSaveFolder','Bool'],
        ["Offset in Charter", "If checked, this will enable the Song Offset option in the Chart Editor too.", [], 'charterOffset','Bool'],
    ]
];